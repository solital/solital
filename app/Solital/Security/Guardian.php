...
class Guardian
{
    ...
    public function fields(string $column_email, string $column_pass, string $email, string $password)
    {
        try {
    ...
    public static function validate(string $session, string $index = INDEX_LOGIN) 
    {
        self::verifyConstants();
