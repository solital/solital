...
use Solital\Course\Event\EventArgument;
...
class EventHandlerTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAllEventTriggered()
    {
        ...
        // Add rewrite
        TestRouter::error(function (\Solital\Http\Request $request, \Exception $error) {
        ...
        // Add csrf-verifier
        $csrfVerifier = new \Solital\Http\Middleware\BaseCsrfVerifier();
    ...
    public function testPrefixEvent()
    {
        ...
        $eventHandler->register(EventHandler::EVENT_ADD_ROUTE, function (EventArgument $arg) use (&$status) {
            ...
            if ($arg->route instanceof \Solital\Course\Route\LoadableRoute) {
