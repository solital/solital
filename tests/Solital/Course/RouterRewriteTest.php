...
class RouteRewriteTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->expectException(\Solital\Course\Exceptions\NotFoundHttpException::class);
    ...
    public function testRewriteRouteFromRoute()
    {
        ...
        TestRouter::get('/match', function () {
            TestRouter::request()->setRewriteRoute(new \Solital\Course\Route\RouteUrl('/match', function () {
                return 'ok';
            }));
        });
